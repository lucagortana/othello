...
def alphaBeta(othellier, prof, maximizing_player, alpha, beta,  gains, chemin, profondeurs):
    '''
    ...
    if othellier.joueur[0] == maximizing_player: #maximizing_player vaut soit 1 soit 2 selon quel joueur on souhaite maximiser
        for case in cases_possibles:
            ...
            score = alphaBeta(oth_fils, prof - 1, maximizing_player, alpha, beta, gains, chemin, profondeurs)[0]
            gains.append(score)
            chemin.append(case)
